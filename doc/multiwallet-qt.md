...
In order to support loading of multiple wallets in creacoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is creacoin.cpp.
...
Changes to creacoin.cpp
----------------------
creacoin.cpp is the entry point into creacoin-qt, and as such, will require some minor modifications to provide hooks for
