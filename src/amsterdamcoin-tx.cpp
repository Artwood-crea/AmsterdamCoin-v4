...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CreaCoin Core creacoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  creacoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded creacoin transaction") + "\n" +
                               "  creacoin-tx [options] -create [commands]   " + _("Create hex-encoded creacoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded creacoin transaction
