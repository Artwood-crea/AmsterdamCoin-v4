...
/** Utility functions used by the CreaCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CreaCoin addresses in monospace font
...
// Parse "creacoin:" URI into recipient object, return true on successful parsing
