...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CreaCoin Core"),
     ...
     * override -datadir in the creacoin.conf file in the default data directory
     * (to be consistent with creacoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
