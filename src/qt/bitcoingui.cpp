                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CreaCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CreaCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and creacoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCREA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CreaCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CreaCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CreaCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CreaCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CreaCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CreaCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CreaCoin Core help message to get a list with possible CreaCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CreaCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CreaCoin network", "", count));
}
...
{
    QString strTitle = tr("CreaCoin Core"); // default title
