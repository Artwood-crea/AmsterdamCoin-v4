                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received AMS from zCREA"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCREA"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCREA));
