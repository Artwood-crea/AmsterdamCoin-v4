...
This means one can have an always-on creacoind instance running, and another local creacoind/creacoin-qt instance which connects to this node and receives blocks from it.
