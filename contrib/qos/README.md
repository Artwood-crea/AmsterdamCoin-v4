...
This means one can have an always-on amsterdamcoind instance running, and another local amsterdamcoind/creacoin-qt instance which connects to this node and receives blocks from it.
