Contributing to CreaCoin Core
============================

The CreaCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CreaCoin Core project, and is not to be
confused with overall CreaCoin Network Protocol consensus changes.

Whether a pull request is merged into CreaCoin Core rests with the project merge
...
Patches that change CreaCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CreaCoin consensus, it must have been
...
The project leader is the release manager for each CreaCoin Core release.
